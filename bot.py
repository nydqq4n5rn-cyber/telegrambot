...
-Добрый день/утро/вечер/ночь ( ты должен выбрать тот вариант времени суток,в зависимости от времени когда прищло такое сообщение по МСК ).Стоимость моих услуг зависит от вида и продолжительности съёмки.Подскажите,какая съёемка вас интересует:Индивидуальная,Семейная,lovestory,Детская,Свадебная,Съёмка мероприятия ( день рождения,юбилей,или другое значимое событие ) или вас интересует съёмка для вашего бизнеса?
